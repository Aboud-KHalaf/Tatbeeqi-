...
import 'package:tatbeeqi/features/courses_content/domain/usecases/fetch_recent_lessons_usecase.dart';
...
void initCourseContentDependencies(GetIt sl) {
  ...
  sl.registerFactory(() => RecentLessonsCubit(fetchRecentLessonsUseCase: sl()));
  ...
  sl.registerLazySingleton(() => FetchRecentLessonsUseCase(sl()));
