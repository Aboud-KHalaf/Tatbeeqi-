...
import 'package:tatbeeqi/features/courses_content/presentation/widgets/lesson_info_buttom_sheet.dart';
...
class _CourseContentCardState extends State<CourseContentCard>
  ...
  void _onLongPress() {
    ...
    _showLessonInfoBottomSheet();
  }

  void _showLessonInfoBottomSheet() {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => LessonInfoBottomSheet(lesson: widget.lessonItem),
    );
  }
