...
class ScrollAnimatedCreatePostBar extends StatefulWidget {
  final ValueNotifier<double> scrollOffset;

  const ScrollAnimatedCreatePostBar({
    super.key,
    required this.scrollOffset,
  });

  @override
  State<ScrollAnimatedCreatePostBar> createState() =>
      _ScrollAnimatedCreatePostBarState();
}

class _ScrollAnimatedCreatePostBarState
    extends State<ScrollAnimatedCreatePostBar> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Gentle breathing animation controller
      ...
      child: FadeTransition(
        ...
        child: ValueListenableBuilder<double>(
          ...
          builder: (context, scrollValue, child) {
            ...
            // Scale effect - slightly shrinks as user scrolls
            final scrollScale = 1.0 - (scrollProgress * 0.02);
            ...
            return Transform.translate(
              ...
              child: AnimatedBuilder(
                animation:
                    Listenable.merge([_breatheAnimation, _shimmerAnimation]),
                builder: (context, child) {
                  return Transform.scale(
                    scale: _breatheAnimation.value * scrollScale,
                    child: Opacity(
